...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "CodeStarNotifications", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/CodeStarNotifications"),
        ...
        .target(name: "SSO", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/SSO"),
        .target(name: "SSOOIDC", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/SSOOIDC"),
        ...
        .target(name: "SavingsPlans", dependencies: ["AWSSDKSwiftCore"], path: "./Sources/AWSSDKSwift/Services/SavingsPlans"),
